...
from src.data_manager_fixed import data_manager
    ...
    try:
        ...
        if not symbols:
            ...
            symbols = binance_client.filter_symbols_by_criteria(
                min_volume_24h=config.trading.min_volume_24h, max_symbols=50
            )
...
def main():
    ...
    backtest_parser.add_argument(
        "--symbols", nargs="+", default=["BTCUSDT", "ETHUSDT"], help="Symbols to test"
    )
